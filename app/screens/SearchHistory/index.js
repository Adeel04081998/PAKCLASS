...
export default function SearchHistory({navigation}) {
  ...
  const [searchHistory, setSearchHistory] = useState([
    {id: '1', keyword: 'I phone'},
    {id: '2', keyword: 'Oppo P20'},
    {id: '3', keyword: 'i phone 13'},
    {id: '4', keyword: 'asus rog'},
    {id: '5', keyword: 'poco'},
  ]);
  const [discoverMore] = useState([
    {id: '1', keyword: 'I phone 12'},
    {id: '2', keyword: ' new poco phones'},
    {id: '3', keyword: 'promo deals'},
  ]);
  const [recentlyView] = useState([
    {id: '1', name: 'Huawai', image: Images.trip1},
    {id: '2', name: 'apple', image: Images.trip2},
    {id: '3', name: 'poco', image: Images.trip3},
    {id: '4', name: 'xioumi', image: Images.trip4},
  ]);
